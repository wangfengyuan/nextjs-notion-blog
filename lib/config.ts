...
export const wechatPublicName: string | null = getSiteConfig('wechatPublicName', null)
export const wechatPublicURL: string | null = getSiteConfig('wechatPublicURL', null)
